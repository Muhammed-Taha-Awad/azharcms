        ...
        <div data-repeater-item class="border rounded-3 p-3 mb-3">
            ...
            <div class="row g-3">
                <div class="col-12">
                    ...
                    <input class="form-control" name="category" value="{{ data_get($card, 'category') }}" placeholder="{{ __('Industry') }}" />
                </div>
                <div class="col-12">
                    <label class="form-label">{{ __('Title') }}</label>
                    <input class="form-control" name="title" value="{{ data_get($card, 'title') }}" placeholder="{{ __('Initiative title') }}" />
                </div>
                <div class="col-12">
                    <label class="form-label">{{ __('Description') }}</label>
                    <textarea class="form-control" name="description" rows="3" placeholder="{{ __('Brief description') }}">{{ data_get($card, 'description') }}</textarea>
                </div>
                <div class="col-12">
    ...
    @empty
        <div data-repeater-item class="border rounded-3 p-3 mb-3">
            ...
            <div class="row g-3">
                <div class="col-12">
                    <label class="form-label">{{ __('Category') }}</label>
                    <input class="form-control" name="category" placeholder="{{ __('Industry') }}" />
                </div>
                <div class="col-12">
                    <label class="form-label">{{ __('Title') }}</label>
                    <input class="form-control" name="title" placeholder="{{ __('Initiative title') }}" />
                </div>
                <div class="col-12">
                    <label class="form-label">{{ __('Description') }}</label>
                    <textarea class="form-control" name="description" rows="3" placeholder="{{ __('Brief description') }}"></textarea>
                </div>
                <div class="col-12">
                    <label class="form-label">{{ __('Image') }}</label>
