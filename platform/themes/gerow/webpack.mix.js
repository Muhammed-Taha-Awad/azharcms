...
mix
    ...
    .sass(`${source}/assets/sass/azhar.scss`, `${dist}/css`)
    ...
    .js(`${source}/assets/js/azhar.js`, `${dist}/js`)

if (mix.inProduction()) {
    mix
        .copy(`${dist}/css/style.css`, `${source}/public/css`)
        .copy(`${dist}/css/rtl.css`, `${source}/public/css`)
        .copy(`${dist}/css/azhar.css`, `${source}/public/css`)
        ...
        .copy(`${dist}/js/azhar.js`, `${source}/public/js`)
}
