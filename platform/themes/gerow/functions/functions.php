        ...
        switch (get_class($data)) {
                ...
                $form
                    ...
                    ->addAfter('breadcrumb_background_image', 'header_style', 'customSelect', [
                        ...
                        'choices' => [
                            ...
                            'azhar-dark' => __('Azhar Header (Dark)'),
                            'azhar-light' => __('Azhar Header (Light)'),
                        ],
            ...
            case Package::class:
                ...
                $form
                    ...
                    ->addAfter('rowOpen', 'action_label', 'text', [
                        'label' => __('Action label'),
                        'label_attr' => ['class' => 'form-label'],
                        'value' => $data->getMetaData('action_label', true),
                        'wrapper' => [
                            'class' => 'col-md-6',
                        ],
                    ])
                    ->addAfter('action_label', 'action_url', 'url', [
                        'label' => __('Action URL'),
                        'label_attr' => ['class' => 'form-label'],
                        'value' => $data->getMetaData('action_url', true),
                        'wrapper' => [
                            'class' => 'col-md-6',
                        ],
                        'attr' => [
