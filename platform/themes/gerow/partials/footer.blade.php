@php
    $preFooterStyle = Theme::get('preFooterSidebarStyle');
    $footerStyle = Theme::get('footerStyle', 'default');
@endphp

@if (in_array($footerStyle, ['azhar-dark', 'azhar-light']))
    {!! Theme::partial('azhar.footer', ['variant' => $footerStyle === 'azhar-light' ? 'light' : 'dark']) !!}
    {!! Theme::footer() !!}
@else
    @switch($preFooterStyle)
        @case('style-1')
