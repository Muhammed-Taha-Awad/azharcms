...
app()->booted(function () {
    Shortcode::register('azhar-hero', __('Azhar Hero'), __('Homepage hero slider for Azhar'), function (ShortcodeCompiler $shortcode): ?string {
    ...
    Shortcode::register('azhar-company-overview', __('Azhar Company Overview'), __('Company overview section for Azhar'), function (ShortcodeCompiler $shortcode): ?string {
    ...
    Shortcode::register('azhar-sectors', __('Azhar Sectors'), __('Business sectors carousel for Azhar'), function (ShortcodeCompiler $shortcode): ?string {
    ...
    Shortcode::register('azhar-newsroom', __('Azhar Newsroom'), __('Latest news section for Azhar'), function (ShortcodeCompiler $shortcode): ?string {
    ...
    Shortcode::register('azhar-portfolio', __('Azhar Portfolio'), __('Portfolio highlight section for Azhar'), function (ShortcodeCompiler $shortcode): ?string {
    ...
    Shortcode::register('azhar-sustainability', __('Azhar Sustainability'), __('Sustainability spotlight section for Azhar'), function (ShortcodeCompiler $shortcode): ?string {
    ...
    Shortcode::register('azhar-subsidiaries', __('Azhar Subsidiaries'), __('Subsidiaries logo grid for Azhar'), function (ShortcodeCompiler $shortcode): ?string {
    ...
    Shortcode::register('azhar-geography', __('Azhar Geography'), __('Geography highlight section for Azhar'), function (ShortcodeCompiler $shortcode): ?string {
    ...
    Shortcode::register('site-statistics', __('Site statistics'), __('Site statistics'), function (ShortcodeCompiler $shortcode): ?string {
        $tabs = Shortcode::fields()->getTabsData(['title', 'icon', 'data', 'unit'], $shortcode);
